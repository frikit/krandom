...
Properties: `FirstName`, `LastName`, `FullName`, `Gender`, `DateOfBirth`, `Email`, `UserName`, `Avatar`, `Phone`, `Website`, `Address` (Street, Suite, City, State, ZipCode, Geo), `Company` (Name, CatchPhrase, Bs).
...
**Selected locales:** `ar`, `az`, `cz`, `da`, `de`, `de_AT`, `de_CH`, `el`, `en`, `en_AU`, `en_CA`, `en_GB`, `en_IE`, `en_IND`, `en_NG`, `en_ZA`, `es`, `es_MX`, `fa`, `fi`, `fr`, `fr_BE`, `fr_CA`, `fr_CH`, `hr`, `hu`, `hy`, `id_ID`, `it`, `ja`, `ko`, `lv`, `nb_NO`, `ne`, `nl`, `nl_BE`, `pl`, `pt_BR`, `pt_PT`, `ro`, `ru`, `sk`, `sl`, `sr_Cyrl_RS`, `sr_Latn_RS`, `sv`, `tr`, `uk`, `vi`, `zh_CN`, `zh_TW`, `ge`, `ur`.
