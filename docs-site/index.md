...
object graph population. The latest stable release is 2.4.0, which is used by the public
installation examples. Repository-local snapshots are intended for development verification.
