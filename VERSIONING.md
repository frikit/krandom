...
`2.6.0-SNAPSHOT`, compared against the released `2.5.0` public API. The [2.5.0 plan](docs/development/release-2.5.0-plan.md) records the latest compatible determinism-hardening
