...
- Latest stable release: `2.5.0`; current repository development line: `2.6.0-SNAPSHOT`.
...
The latest released version is `2.5.0`. Release availability is shown on
...
```kotlin
dependencies {
    implementation("io.github.frikit:krandom-core:2.5.0")
}
```
