...
application {
    mainModule.set("io.github.frikit.krandom.examples.jpms.jackson")
    mainClass.set("io.github.frikit.krandom.examples.jpms.jacksonconsumer.JacksonConsumer")
}
